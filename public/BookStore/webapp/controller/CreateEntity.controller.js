sap.ui.define([
	...
	return BaseController.extend("pottmeier.bookstore.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("BookSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("BookSet", oData);
