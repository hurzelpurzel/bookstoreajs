...
var Book = (_dec = queryable({ pageSize: 10, maxTop: 100 }), _dec2 = router['/50off'], (_class = function (_Resource) {
  ...
  _createClass(Book, [{
    ...
    key: 'halfPriceAction',
    value: function () {
      var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(id, params, next) {
        var entity;
      ...
      return function halfPriceAction(_x6, _x7, _x8) {
        return ref.apply(this, arguments);
      };
    }()
  }]);
  ...
  return Book;
}(_ODataResource2.default), (_applyDecoratedDescriptor(_class.prototype, 'onGetList', [_dec], Object.getOwnPropertyDescriptor(_class.prototype, 'onGetList'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'onRemove', [myAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'onRemove'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'onUpdate', [myAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'onUpdate'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'halfPriceAction', [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, 'halfPriceAction'), _class.prototype)), _class));
